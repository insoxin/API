		...
		if (!empty($postStr)){
				...
				switch($postObj->MsgType)
				{
					case 'event':
						...
						{
						//关注后的回复
												$contentStr = "欢迎关注【焦作大学信息工程学院】,这里会给我们带来信息工程学院里不一样的风情。输入[关键词]即可获取相关内容";
					...
					case 'text':
						{
 						...
 						if($keyword<>"")
						{
										$title = '您要找的《'.$keyword.'》,给您找到以下结果：';
										
										$des1 ="";
										//图片地址
										$picUrl1 ="https://api.isoyu.com/bing_images.php";
										//跳转链接
										$url="http://www.baidu.com/s?si=jzu.edu.cn&cl=3&ct=2097152&tn=baidulocal&word=".$keyword;
        	...
        	echo "你好！欢迎进入【<?php $this->options->title() ?>】微信公众号，这里会给我们带来信息工程学院里不一样的风情";
        	exit;
        }
    }
