...
/*$im = imagecreatefromjpeg("kongbai.png");*/
...
imagettftext($im, $size, $angle, 10, 15, $grey, $font, "CDN地址：".address($_SERVER['REMOTE_ADDR']));
imagettftext($im, $size, $angle, 10, 35, $grey, $font, "当前IP：".$_SERVER['HTTP_X_FORWARDED_FOR']);
...
imagettftext($im, $size, $angle, 10, 95, $grey, $font, $signature!=""?$signature:"姬长信API  api.isoyu.com");
